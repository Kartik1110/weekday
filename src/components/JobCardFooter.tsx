...
export default function JobCardFooter({ minExperience }: { minExperience: number | null }) {
    ...
    return (
        <div className="job-card-footer">
            ...
            <h2 className='job-header-exp'>{minExperience === null ? 'Not required' : minExperience + ' Years'}</h2>
